/**
 * feat-corporate — GET/POST /api/corporate-inquiries
 *
 * Corporate inquiry list with Sieve filtering and creation.
 *
 * Consumer stub:
 * ```ts
 * export { corporateInquiriesGET as GET, corporateInquiriesPOST as POST } from "@mohasinac/feat-corporate";
 * ```
 */
