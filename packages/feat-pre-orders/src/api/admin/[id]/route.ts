/**
 * feat-pre-orders — GET/PATCH /api/admin/pre-orders/[id]
 *
 * Admin pre-order detail retrieval and updates.
 *
 * Consumer stub:
 * ```ts
 * export { adminPreOrderDetailGET as GET, adminPreOrderDetailPATCH as PATCH } from "@mohasinac/feat-pre-orders";
 * ```
 */
