/**
 * feat-homepage — GET/POST /api/homepage/sections
 *
 * Homepage sections list with Sieve filtering and creation.
 *
 * Consumer stub:
 * ```ts
 * export { sectionsListGET as GET, sectionsListPOST as POST } from "@mohasinac/feat-homepage";
 * ```
 */
