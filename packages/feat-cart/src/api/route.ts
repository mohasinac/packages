/**
 * feat-cart — GET/POST /api/cart
 *
 * User cart list with Sieve filtering and cart creation.
 *
 * Consumer stub:
 * ```ts
 * export { cartListGET as GET, cartListPOST as POST } from "@mohasinac/feat-cart";
 * ```
 */
