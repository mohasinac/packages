/**
 * feat-collections — GET/POST /api/collections
 *
 * Collections list with Sieve filtering and creation.
 *
 * Consumer stub:
 * ```ts
 * export { collectionsListGET as GET, collectionsListPOST as POST } from "@mohasinac/feat-collections";
 * ```
 */
