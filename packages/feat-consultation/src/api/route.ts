/**
 * feat-consultation — GET/POST /api/consultations
 *
 * Consultations list with Sieve filtering and creation.
 *
 * Consumer stub:
 * ```ts
 * export { consultationsListGET as GET, consultationsListPOST as POST } from "@mohasinac/feat-consultation";
 * ```
 */
